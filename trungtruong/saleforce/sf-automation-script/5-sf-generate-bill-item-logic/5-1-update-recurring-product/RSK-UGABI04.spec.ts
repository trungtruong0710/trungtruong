...
test.describe('Update last billing period', () => {

    test('Update product in first billing ratio', async ({ page }) => {

        await login.adminSignIn();
        const studentUrl = await sFCreateNewStudent.createStudentWithPaymentDetailOnly('RSK-UGABI4:1 ', environment.gradeRSK);
        ...
        await sFBilling.updateProduct(
            {
                ...
                updateOptions: {
                    ...
                    effectiveDate: sF_DateTime.startDate_2141Jan01[0],
                    updatePackage: null,
                    numberOfSlot: null
                }
            }
            ...
            [
                {
                    ...
                    startDate: sF_DateTime.startDate_2141Jan01
                }
            ]
        );
    ...
    test('Update product in second billing ratio', async ({ page }) => {
        ...
        await login.adminSignIn();
        const studentUrl = await sFCreateNewStudent.createStudentWithPaymentDetailOnly('RSK-UGABI4:2 ', environment.gradeRSK);
        await sFCommonStep.access_ContactDetail(studentUrl);
        // create enrollment application
        await sFContactDetail.clickBtn_BillingTab();
        await sFContactDetail.clickBtn_ApplicationsTab();
        ...
        await sFBilling.updateProduct(
            {
                ...
                updateOptions: {
                    ...
                    isRemoveDiscount: false,
                    discount: discount.Percent10,
                    effectiveDate: sF_DateTime.startDate_2151Jan01[0],
                    updatePackage: null,
                    numberOfSlot: null
                }
            }
            ...
            [
                {
                    ...
                    discountLabel: discount.Percent10,
                    startDate: sF_DateTime.startDate_2151Jan01
                }
            ]
        );
        await sFOrderDetail.assertOrderDetailBilling(
            ...
            [
                {
                    ...
                    productStatus: productStatus.ordered,
                    durationIsCurrentDate: false,
                    duration: sF_DateTime.duration_2021Jan01_2150Dec31,
                    upcomingBillingDate: sF_DateTime.text_31Dec2080
                }
            ]
        );
    ...
    test('Update product in last billing ratio', async ({ page }) => {
        ...
        await login.adminSignIn();
        const studentUrl = await sFCreateNewStudent.createStudentWithPaymentDetailOnly('RSK-UGABI4:3 ', environment.gradeRSK);
        await sFCommonStep.access_ContactDetail(studentUrl);
        // create enrollment application
        await sFContactDetail.clickBtn_BillingTab();
        await sFContactDetail.clickBtn_ApplicationsTab();
        ...
        await sFBilling.updateProduct(
            {
                ...
                updateOptions: {
                    ...
                    isRemoveDiscount: false,
                    discount: discount.Percent10,
                    effectiveDate: sF_DateTime.startDate_2171Jan01[0],
                    updatePackage: null,
                    numberOfSlot: null
                }
            }
            ...
            [
                {
                    ...
                    discountLabel: discount.Percent10,
                    startDate: sF_DateTime.startDate_2171Jan01
                }
            ]
        );
        await sFOrderDetail.assertOrderDetailBilling(
            ...
            [
                {
                    ...
                    productStatus: productStatus.ordered,
                    durationIsCurrentDate: false,
                    duration: sF_DateTime.duration_2021Jan01_2170Dec31,
                    upcomingBillingDate: sF_DateTime.text_31Dec2080
                }
            ]
        );
