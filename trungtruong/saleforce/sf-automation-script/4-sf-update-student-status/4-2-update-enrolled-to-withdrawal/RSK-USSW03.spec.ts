import { test, login, sFCreateNewStudent, sFContactDetail, sFApplications, sFBilling, sFCommonStep, sFAssertBODBillItem, sFAssertBODAmount, sFAssertUpcomingBilling } from '../../../sf-page/test-hook';
...
test.describe('Able to create withdrawal order', () => {

    test('Enrolled student is able to create Withdrawal order', async ({ page }) => {

        await login.adminSignIn();
        const studentUrl = await sFCreateNewStudent.createStudentWithPaymentDetailOnly('RSK-USSW03:1 ', environment.gradeRSK);
