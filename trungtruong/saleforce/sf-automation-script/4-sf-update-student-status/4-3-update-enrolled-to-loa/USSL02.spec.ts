...
test.describe.skip('Able to create LOA order', () => {

    test('Enrolled student is able to create LOA order', async ({ page }) => {

        await login.adminSignIn();
        const studentUrl = await sFCreateNewStudent.createStudentWithPaymentDetailOnly('USSL02 ', environment.grade);
