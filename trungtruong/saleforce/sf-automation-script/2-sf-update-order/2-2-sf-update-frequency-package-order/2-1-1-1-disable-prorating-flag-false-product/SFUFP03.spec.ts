...
test.describe('Update frequency package product (eff.date has the same billing_schedule_period but different billing ratio)', () => {
    ...
    test('Update discount', async ({ page }) => {
        ...
        await sFAssertUpcomingBilling.assert_UB_Price([price.minusYen33]); // (1000*1/3) - ((1000*1/3)-((1000*1/3)*0.1))
        ...
        await sFBilling.assert_Billing_Billing_Amount([price.Yen900, price.Yen900, price.minusYen33, price.Yen666]);
    ...
    test('Increase slot for associate course', async ({ page }) => {
        ...
        await sFAssertUpcomingBilling.assert_UB_Price([price.Yen266]); // ((2000*1/3)-((2000*1/3)*0.1)) - (1000*1/3)
        await sFAssertUpcomingBilling.assert_UB_BillingDate_2050Dec31_Array0();
        await sFCommonStep.click('Next');
        await sFCommonStep.click('Submit');
        await sFOrderDetail.assert_OrderDetail_OrderStatus(status.submitted);
        ...
        await sFBilling.assert_Billing_Billing_BillingStatus([status.pending, status.pending, status.pending, status.pending]);
        await sFBilling.assert_Billing_Billing_Amount([price.Yen1800, price.Yen1800, price.Yen266, price.Yen666]);
        await sFBilling.assert_Billing_Billing_BillingDateIs2110Dec31_Array0();
        await sFBilling.assert_Billing_Billing_BillingDateIs2080Dec31_Array1();
        await sFBilling.assert_Billing_Billing_BillingDateIs2050Dec31_Array2();
        await sFBilling.assert_Billing_Billing_BillingDateIs2050Dec31_Array3();
    ...
    test('Decrease slot for associate course', async ({ page }) => {
        ...
        await sFCreateOrder.click_RemoveDiscount();
        await sFCreateOrder.assert_BOD_NoInformation();
        await sFAssertUpcomingBilling.assert_UB_Price([price.Yen1333]);
        await sFCommonStep.click('Submit');
        await sFOrderDetail.assert_OrderDetail_OrderStatus(status.submitted);
        await sFCommonStep.access_ContactDetail(studentUrl);
        await sFContactDetail.clickBtn_BillingTab();
        ...
        await sFAssertUpcomingBilling.assert_UB_BillItemPackage_BillingPeriodAndRatio([true], [billingPeriod.period_2051_2080], [billingPeriod.ratio13]);
        await sFAssertUpcomingBilling.assert_UB_BillItemPackage_AssociateCourse(['require course only'], [FP.FP_REQ_1SLOTWk], [FP.FP_OPTIONAL1_1SLOTWk], [FP.FP_OPTIONAL2_1SLOTWk])
        await sFAssertUpcomingBilling.assert_UB_Price([price.minusYen367]); // ((1000*1/3)-((1000*1/3)*0.1)) - (2000*1/3)
        await sFAssertUpcomingBilling.assert_UB_BillingDate_2050Dec31_Array0();
        await sFCommonStep.click('Next');
        await sFCommonStep.click('Submit');
        await sFOrderDetail.assert_OrderDetail_OrderStatus(status.submitted);
        ...
        await sFOrderDetail.assert_OrderDetail_BillingDateIsIs2110Dec31_Array0();
        await sFOrderDetail.assert_OrderDetail_BillingDateIsIs2080Dec31_Array1();
        await sFOrderDetail.assert_OrderDetail_Amount([price.Yen2000, price.Yen2000]);
        await sFCommonStep.access_ContactDetail(studentUrl);
        await sFContactDetail.clickBtn_BillingTab();
        await sFBilling.assert_Billing_ProductList_Discount(['--']);
        ...
        await sFBilling.assert_Billing_Billing_BillingStatus([status.pending, status.pending, status.pending, status.pending]);
        await sFBilling.assert_Billing_Billing_Amount([price.Yen900, price.Yen900, price.minusYen367, price.Yen1333]);
        await sFBilling.assert_Billing_Billing_BillingDateIs2110Dec31_Array0();
        await sFBilling.assert_Billing_Billing_BillingDateIs2080Dec31_Array1();
        await sFBilling.assert_Billing_Billing_BillingDateIs2050Dec31_Array2();
        await sFBilling.assert_Billing_Billing_BillingDateIs2050Dec31_Array3();
