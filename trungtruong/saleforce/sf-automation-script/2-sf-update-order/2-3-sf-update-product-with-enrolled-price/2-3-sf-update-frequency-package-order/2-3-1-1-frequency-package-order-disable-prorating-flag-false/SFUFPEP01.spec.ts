...
test.describe('Update frequency package product (eff.date has the same billing_schedule_period but different billing ratio)', () => {
    ...
    test('Update discount', async ({ page }) => {
        ...
        const studentUrl = await sFCreateNewStudent.createStudentWithPaymentDetailOnly_Old('SFUFPEP01:1 ');
        ...
        await sFAssertBODAmount.assertBilledAtOrderTotal(false, price.minusYen133);
    ...
    test('Update discount with recurring_valid_duration = 1', async ({ page }) => {
        ...
        await login.adminSignIn();
        const studentUrl = await sFCreateNewStudent.createStudentWithPaymentDetailOnly_Old('SFUFPEP01:2 ');
        await sFCommonStep.access_ContactDetail(studentUrl);
        // create enrollment application
        await sFContactDetail.clickBtn_BillingTab();
        await sFContactDetail.clickBtn_ApplicationsTab();
    ...
    test('Increase slot for associate course', async ({ page }) => {
        ...
        await login.adminSignIn();
        const studentUrl = await sFCreateNewStudent.createStudentWithPaymentDetailOnly_Old('SFUFPEP01:3 ');
        await sFCommonStep.access_ContactDetail(studentUrl);
        // create enrollment application
        await sFContactDetail.clickBtn_BillingTab();
        await sFContactDetail.clickBtn_ApplicationsTab();
        ...
        await sFAssertBODAmount.assertBilledAtOrderTotal(false, price.Yen1066);
        await sFAssertUpcomingBilling.assert_UB_PackageBillItem(
            [
                {
                    productName: FP.FP3_T10,
    ...
    test('Decrease slot for associate course', async ({ page }) => {
        ...
        await login.adminSignIn();
        const studentUrl = await sFCreateNewStudent.createStudentWithPaymentDetailOnly_Old('SFUFPEP01:4 ');
        await sFCommonStep.access_ContactDetail(studentUrl);
        // create enrollment application
        await sFContactDetail.clickBtn_BillingTab();
        await sFContactDetail.clickBtn_ApplicationsTab();
            ...
            [
                {
                    ...
                    discountLabel: null,
                    isProductPricePositive: false,
                    productPrice: price.minusYen367
                },{
                    productName: FP.FP3_T10,
                    isAdjustment: true,
                    billingPeriod: billingPeriod.period_2051_2080,
        ...
        await sFAssertBODAmount.assertBilledAtOrderTotal(false, price.minusYen1467);
        await sFAssertUpcomingBilling.assert_UB_PackageBillItem(
            [
                {
                    productName: FP.FP3_T10,
            ...
            [
                {
                    ...
                    billingStatus: status.billed,
                    billingDate: sFCommonStep.currentDate,
                    billingAmount: price.minusYen367
                },{
                    isAdjustment: false,
                    isRecurringProduct: true,
                    billingPeriod: billingPeriod.period_2111_2140,
    ...
    test('Update add associate course', async ({ page }) => {
        ...
        await login.adminSignIn();
        const studentUrl = await sFCreateNewStudent.createStudentWithPaymentDetailOnly_Old('SFUFPEP01:5 ');
        await sFCommonStep.access_ContactDetail(studentUrl);
        // create enrollment application
        await sFContactDetail.clickBtn_BillingTab();
        await sFContactDetail.clickBtn_ApplicationsTab();
    ...
    test('Update remove associate course', async ({ page }) => {
        ...
        await login.adminSignIn();
        const studentUrl = await sFCreateNewStudent.createStudentWithPaymentDetailOnly_Old('SFUFPEP01:6 ');
        await sFCommonStep.access_ContactDetail(studentUrl);
        // create enrollment application
        await sFContactDetail.clickBtn_BillingTab();
        await sFContactDetail.clickBtn_ApplicationsTab();
