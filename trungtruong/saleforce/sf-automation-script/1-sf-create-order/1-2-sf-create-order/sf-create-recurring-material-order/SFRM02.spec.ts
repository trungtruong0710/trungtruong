import { test, login, sFCreateNewStudent, sFContactDetail, sFCreateOrder, sFCreateRM, sFAssertUpcomingBilling, sFOrderDetail, sFBilling, sFCommonStep } from '../../../../sf-page/test-hook';

test.describe('Create recurring material order with upcoming billing only', () => {

    test('Create recurring material order with upcoming billing only and not apply discount', async ({ page }) => {
    ...
    test('Create recurring material order with upcoming billing only and apply percentage discount', async ({ page }) => {
    ...
    test('Create recurring material order with upcoming billing only and apply fixed amount discount', async ({ page }) => {
        ...
        await sFBilling.assert_Billing_Billing_AmountIsYen1933_Array2();
        await sFBilling.assert_Billing_Billing_BillingName_2051_2080_Ratio23_Array2();
