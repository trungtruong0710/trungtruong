...
test.describe('Create recurring material product', () => {
    ...
    test('Create recurring material product', async () => {
        await login.adminSignIn();
        await sFCommonStep.access_ProductOffering_Url();
        await sFGeneralInfo.fill_RM_ProductName();
        ...
        await sFProductDetail.select_MaterialType_RM();
