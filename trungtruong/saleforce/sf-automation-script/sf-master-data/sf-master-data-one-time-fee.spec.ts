...
test.describe('Create one-time fee product', () => {
    ...
    test('Create one-time fee product', async () => {
        await login.adminSignIn();
        await sFCommonStep.access_ProductOffering_Url();
        await sFGeneralInfo.fill_OTF_ProductName();
        ...
        await sFProductDetail.select_FeeType_OTF();
