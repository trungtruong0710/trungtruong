...
test.describe('Create scheduled package product', () => {
    ...
    test('Create scheduled package product', async () => {
        await login.adminSignIn();
        await sFCommonStep.access_ProductOffering_Url();
        await sFGeneralInfo.fill_SP_ProductName();
        ...
        await sFProductDetail.select_PackageType_SP();
