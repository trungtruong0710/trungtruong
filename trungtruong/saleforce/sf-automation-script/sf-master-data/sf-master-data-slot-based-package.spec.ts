...
test.describe('Create slot-based package product', () => {
    ...
    test('Create slot-based package product', async () => {
        await login.adminSignIn();
        await sFCommonStep.access_ProductOffering_Url();
        await sFGeneralInfo.fill_SLOTBP_ProductName();
        ...
        await sFProductDetail.select_PackageType_SLOTBP();
        await sFProductDetail.fill_MaxSlot_1();
        await sFProductDetail.fill_PackageStartDate_2021Jan01();
        await sFProductDetail.fill_PackageEndDate_2030Dec31();
