...
test.describe('Create one-time package product', () => {
    ...
    test('Create one-time package product', async () => {
        await login.adminSignIn();
        await sFCommonStep.access_ProductOffering_Url();
        await sFGeneralInfo.fill_OTP_ProductName();
        ...
        await sFProductDetail.select_PackageType_OTP();
